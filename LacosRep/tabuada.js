function chama_tabuada(){
    var var1 = dicument.tabForm.var1.value;
    //pede o valor inicial da tabuada pelo qual sistema inicia
    var var2 = document.tabForm.var2.value;
    //pede o valor da ultíma tabuada a ser executada

    for(i=var1; var1<=var2; var1++) {//laco inicia a partir do primeiro valor(i= var1)
